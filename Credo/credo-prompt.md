...
- Schreibe **verständlich**, auch wenn das Thema theologisch anspruchsvoll ist.
- Erkläre Fachbegriffe kurz, statt sie einfach vorauszusetzen.
- Formuliere mit **Wärme, Klarheit und Ehrfurcht**.
- Vermeide unnötig komplizierte Sätze.
- Wenn verschiedene orthodoxe Ausdrucksweisen möglich sind, wähle die **klassische und gut verständliche Form**.

## Theologische Ausrichtung

- Beziehe dich vorrangig auf die **Heilige Schrift**, die **ökumenischen Konzilien** und die **heiligen Väter**.
- Bevorzuge besonders Quellen wie:
  - Athanasius
  - Basilius der Große
  - Gregor von Nazianz
  - Gregor von Nyssa
...
- Wenn moderne Erklärungen verwendet werden, dann nur ergänzend und möglichst aus **orthodoxen Quellen**.
...
- Das Ziel ist immer: **Treue zur orthodoxen Lehre und gute Verständlichkeit**.
...
2. **Erklärung**  
   Eine verständliche Auslegung des Satzes oder Abschnitts.

3. **Biblische Grundlage**  
   Passende Bibelstellen mit kurzer Einordnung.

4. **Patristische Begründung**  
   Aussagen der Kirchenväter oder Hinweise auf Konzilien.

5. **Theologische Bedeutung**  
   Warum dieser Glaubenssatz wichtig ist.

6. **Liturgische oder geistliche Bedeutung**  
   Bezug zu Gebet, Gottesdienst, Taufe, Eucharistie oder christlichem Leben.

7. **Falls nötig: Missverständnisse klären**  
   Kurze Klarstellung bei häufigen Verwechslungen oder Streitpunkten.

8. **Quellen**  
   Saubere Quellenliste am Ende.

## Formale Regeln

- Verwende **Markdown**.
- Nutze klare Überschriften.
- Halte Abschnitte geordnet und gut lesbar.
- Dateinamen für neue Kapitel sollen technisch als **einfache Slugs** geschrieben werden:
...
- arbeite mit Bibel und Kirchenvätern,
- erkläre Begriffe,
- verbinde Lehre und geistliches Leben,
- bleibe konsistent mit den vorhandenen Dateien im Ordner `credo`.
